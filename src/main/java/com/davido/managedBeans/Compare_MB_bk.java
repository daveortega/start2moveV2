 ...
 * @author davidortega
 */
@Named(value = "compare_MB_bk")
@ViewScoped
public class Compare_MB_bk implements Serializable {
...
//            tmpCompObj.setHousAndLandChartBar2Values(listOfLandPrices.stream().map(h -> h[3].toString()).toArray(String[]::new));
    ...
    public void returnToOrigin() {
        try {
            ...
            Logger.getLogger(Compare_MB_bk.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
